...
<body>
	<div style="margin: 30px 30px; width: 800px;">
		...
		onclick="location.href='addform.jsp'"><b><i class="bi bi-pencil"></i>글쓰기</b></button>
	</div>
	...
	<table class="table table-bordered">
		...
		<%}else{
			 ...
			 for(int i=0;i<list.size();i++)
			 {
				 ...
				 %>
				 <tr>
				 	<td align="center"><%=no-- %></td> <!-- 내림차순 no-i가능 -->
	...
	<div>
		 ...
		 <%
		 	...
		 	{%>	
		 		...
		 		<a class="page-link" href="boardlist.jsp?currentPage=<%=currentPage-1%>"><i class="bi bi-arrow-left"></i></a>
		 		</li>
		 	<%}
		 	...
		 	{%>
		 		<li class="page-item active">
		 		<a class="page-link" href="boardlist.jsp?currentPage=<%=currentPage+1%>"><i class="bi bi-arrow-right"></i></a>
		 		</li>
		 	<%}
		 %>
		 </ul>
